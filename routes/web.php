...
Route::get('/delete-appp', [ MyController::class,'delete' ]);

Route::get('/deleteapprenants', [ MyController::class,'deleteapprenants' ]);

Route::get('/add-brief', [ MyController::class,'addbrief' ]);
